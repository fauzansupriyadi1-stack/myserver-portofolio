    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div class="relative bg-[#1E3A2B] rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 mb-12 sm:mb-16 overflow-hidden">
            ...
            <div class="relative flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
                ...
                <div class="flex flex-col gap-3 shrink-0 w-full sm:w-auto">
                    <a href="mailto:<?php echo e($settings['contact_email'] ?? 'hello@golfngv.com'); ?>"
                       id="footer-email-cta"
                       class="flex items-center gap-3 px-6 py-4 bg-[#A3E635] text-[#1E3A2B] font-bold rounded-2xl hover:bg-[#b5f043] hover:shadow-xl hover:shadow-[#A3E635]/30 transition-all duration-300 hover:-translate-y-1 group">
                        ...
                        <?php echo e($settings['contact_email'] ?? 'hello@golfngv.com'); ?>

                    </a>
                    <a href="tel:<?php echo e($settings['contact_phone'] ?? '+15550000000'); ?>"
                       class="flex items-center gap-3 px-6 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white font-semibold rounded-2xl hover:bg-white/20 transition-all duration-300 hover:-translate-y-1">
                        ...
                        <?php echo e($settings['contact_phone'] ?? '+1 (555) 000-0000'); ?>
        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-white font-bold text-lg"><?php echo e($settings['site_name'] ?? 'Golfngv'); ?></span>
            </div>

            
            <div class="flex flex-wrap justify-center gap-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Projects', 'Products', 'Team', 'Privacy', 'Contact']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <a href="#" class="text-white/40 hover:text-white/80 text-sm transition-colors duration-200"><?php echo e($link); ?></a>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>

            
            <div class="flex items-center gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($settings['social_twitter'])): ?>
                <a href="<?php echo e($settings['social_twitter']); ?>" target="_blank"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($settings['social_instagram'])): ?>
                <a href="<?php echo e($settings['social_instagram']); ?>" target="_blank"
                   class="w-10 h-10 bg-white/5 border border-white/10 rounded-full flex items-center justify-center text-white/50 hover:text-white hover:bg-white/10 transition-all duration-200 hover:-translate-y-0.5">
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($settings['social_facebook'])): ?>
                <a href="<?php echo e($settings['social_facebook']); ?>" target="_blank"
                   class="w-10 h-10 bg-white/5 border border-white/10 rounded-full flex items-center justify-center text-white/50 hover:text-white hover:bg-white/10 transition-all duration-200 hover:-translate-y-0.5">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($settings['social_youtube'])): ?>
                <a href="<?php echo e($settings['social_youtube']); ?>" target="_blank"
                   class="w-10 h-10 bg-white/5 border border-white/10 rounded-full flex items-center justify-center text-white/50 hover:text-white hover:bg-white/10 transition-all duration-200 hover:-translate-y-0.5">
        ...
        <div class="mt-8 pt-8 border-t border-white/5 text-center">
            <p class="text-white/30 text-xs"><?php echo e($settings['footer_text'] ?? '© 2026 Fauzan Supriyadi. All rights reserved.'); ?></p>
        </div>
    </div>
</footer>

<?php /**PATH C:\Users\fauzan supriyadi\OneDrive\Dokumen\myporto\resources\views/partials/footer.blade.php ENDPATH**/ ?>