    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="sm:row-span-2 lg:row-span-2 relative rounded-3xl overflow-hidden group cursor-pointer min-h-[280px] sm:min-h-[420px]"
                 style="height: 100%;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proj1 && $proj1->image_path): ?>
                    <img src="<?php echo e($proj1->image_url); ?>" alt="<?php echo e($proj1->title); ?>"
                ...
                <?php else: ?>
                    <div class="absolute inset-0 bg-gradient-to-b from-[#1E3A2B] to-[#0a1f13]">
                        ...
                        <div class="absolute inset-0 p-6 flex flex-col justify-center opacity-20">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['> npm run dev','✓ compiled successfully','→ localhost:3000','> git push origin main','✓ deployed to production']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="text-[#A3E635] font-mono text-xs mb-2"><?php echo e($line); ?></div>
                ...
                <div class="absolute bottom-0 left-0 right-0 p-5 sm:p-6">
                    <h3 class="text-white font-bold text-lg"><?php echo e($proj1 ? $proj1->title : 'E-Commerce Platform'); ?></h3>
                    <p class="text-white/60 text-xs mt-1 mb-2"><?php echo e($proj1 ? $proj1->technologies : 'Laravel · MySQL · Stripe'); ?></p>
                    <p class="text-white/60 text-sm"><?php echo e($proj1 ? $proj1->description : 'Full-featured online store with inventory management and payment gateway integration.'); ?></p>
                </div>
            </div>

            
            <div class="relative rounded-3xl overflow-hidden group cursor-pointer h-[200px]">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proj2 && $proj2->image_path): ?>
                    <img src="<?php echo e($proj2->image_url); ?>" alt="<?php echo e($proj2->title); ?>"
                ...
                <div class="absolute bottom-0 left-0 right-0 p-5">
                    <h3 class="text-white font-bold text-sm sm:text-base"><?php echo e($proj2 ? $proj2->title : 'SaaS Dashboard'); ?></h3>
                    <p class="text-white/60 text-xs mt-1"><?php echo e($proj2 ? $proj2->technologies : 'React · Node.js · PostgreSQL'); ?></p>
                </div>
            </div>

            
            <div class="relative rounded-3xl overflow-hidden group cursor-pointer h-[200px]">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proj3 && $proj3->image_path): ?>
                    <img src="<?php echo e($proj3->image_url); ?>" alt="<?php echo e($proj3->title); ?>"
                         class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                <?php else: ?>
                ...
                <div class="absolute bottom-0 left-0 right-0 p-5">
                    <h3 class="text-white font-bold text-sm sm:text-base"><?php echo e($proj3 ? $proj3->title : 'Mobile App Backend'); ?></h3>
                    <p class="text-white/60 text-xs mt-1"><?php echo e($proj3 ? $proj3->technologies : 'Laravel API · JWT · Redis'); ?></p>
                </div>
            </div>

            
            <div class="lg:col-span-2 relative rounded-3xl overflow-hidden group cursor-pointer h-[200px]">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($proj4 && $proj4->image_path): ?>
                    <img src="<?php echo e($proj4->image_url); ?>" alt="<?php echo e($proj4->title); ?>"
                         class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                <?php else: ?>
                ...
                <div class="absolute bottom-0 left-0 right-0 p-5 sm:p-6">
                    <h3 class="text-white font-bold text-lg"><?php echo e($proj4 ? $proj4->title : 'Network Infrastructure'); ?></h3>
                    <p class="text-white/60 text-sm mt-1"><?php echo e($proj4 ? $proj4->technologies : 'Mikrotik • VLAN • VPN'); ?></p>
                </div>
            </div>
        </div>

        
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($projects_total ?? $projects->count()) > 4): ?>
        <div style="display:flex;justify-content:center;margin-top:56px;padding-top:24px;padding-bottom:32px;">
            <a href="<?php echo e(route('projects')); ?>"
               class="inline-flex items-center gap-3 px-8 py-4 bg-[#111827] border-2 border-[#A3E635]/40 text-white font-bold text-sm rounded-full hover:border-[#A3E635] hover:bg-[#1E3A2B] transition-all duration-200 group">
                <span x-show="lang === 'id'">Lihat Semua <?php echo e($projects_total ?? $projects->count()); ?> Project</span>
                <span x-show="lang === 'en'" x-cloak>View All <?php echo e($projects_total ?? $projects->count()); ?> Projects</span>
...
<?php /**PATH C:\Users\fauzan supriyadi\OneDrive\Dokumen\myporto\resources\views/partials/academy.blade.php ENDPATH**/ ?>