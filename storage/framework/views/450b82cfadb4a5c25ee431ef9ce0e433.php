...
<section id="about" class="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-[#F8F9FA]">
    <div class="max-w-7xl mx-auto">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($about->count() > 0): ?>
        <?php $card1 = $about->first(); ?>
        
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            
            
            <div class="relative rounded-3xl overflow-hidden group" style="min-height: 520px;">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($card1->image_path): ?>
                    <img src="<?php echo e($card1->image_url); ?>" alt="<?php echo e($card1->title); ?>"
                ...
                <div class="absolute bottom-0 left-0 right-0 p-5 sm:p-7">
                    ...
                    <h3 class="text-white font-bold text-xl sm:text-2xl mb-2"><?php echo e($card1->title); ?></h3>
                    <p class="text-white/70 text-sm mb-2"><?php echo e($card1->subtitle); ?></p>
                    <p class="text-white/60 text-sm leading-relaxed mb-5"><?php echo e($card1->description); ?></p>
                    <a href="<?php echo e(route('cv')); ?>"
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="relative rounded-3xl overflow-hidden group" style="height: 250px;">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-5 sm:p-6">
                        ...
                        <a href="<?php echo e(route('certifications')); ?>"
...
<?php /**PATH C:\Users\fauzan supriyadi\OneDrive\Dokumen\myporto\resources\views/partials/about.blade.php ENDPATH**/ ?>